...
export default function Header2({results}){
    return (
        <header>
          <div className="row">
            ...
            <div className="col">
                ...
                <div className="col-md-6 col-sm-12">
                        <figure>
                            <img src={results[0]?.multimedia[0]?.url} alt={results[0]?.multimedia[0].caption} className="img-fluid" id="news-feed--subimage"/>
                            <figcaption>
                                <p>{results[0].org_facet}</p>
                                <h5>
